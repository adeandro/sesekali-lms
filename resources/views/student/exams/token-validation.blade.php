...
<div class="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-xl w-full space-y-8">
        <!-- Main Card -->
        <div class="bg-white rounded-[3rem] shadow-2xl shadow-[var(--brand-glow)] overflow-hidden border border-gray-100 transition-all duration-500 hover:shadow-[var(--brand-glow)]/50">
            <!-- Header with Gradient Area -->
            <div class="bg-gradient-to-br from-[var(--brand-primary)] via-[var(--brand-primary)] to-[var(--brand-dark)] px-10 py-12 text-center relative overflow-hidden">
                <!-- Decoration -->
                <div class="absolute top-0 right-0 -mr-16 -mt-16 w-48 h-48 bg-white/10 rounded-full blur-3xl"></div>
                <div class="absolute bottom-0 left-0 -ml-16 -mb-16 w-32 h-32 bg-[var(--brand-glow)]/20 rounded-full blur-2xl"></div>
                ...
                <div class="relative space-y-4">
                    ...
                    <div class="space-y-1">
                        <p class="text-[10px] font-black text-white/60 uppercase tracking-[0.4em] mb-1">Gerbang Keamanan</p>
            ...
            <div class="px-10 py-12 space-y-10">
                ...
                <div class="bg-gray-50 rounded-[2rem] p-6 border border-gray-100 flex items-center justify-between gap-4">
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-[var(--brand-primary)] shadow-sm">
                ...
                <div class="space-y-6">
                    ...
                    <div class="relative group">
                        <div class="absolute -inset-1 bg-gradient-to-r from-[var(--brand-primary)] to-[var(--brand-dark)] rounded-3xl blur opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200"></div>
                        <input type="text" id="tokenInput" 
                            placeholder="••••••" 
                            maxlength="6" 
                            class="relative w-full bg-white px-8 py-6 border-2 border-gray-100 rounded-3xl focus:border-[var(--brand-primary)] focus:outline-none font-mono tracking-[0.6em] text-center text-4xl uppercase font-black text-[var(--brand-primary)] transition-all placeholder:text-gray-100"
                            autocomplete="off"
                            required>
                    </div>
                ...
                <div class="space-y-4">
                    <button type="button" id="validateBtn" 
                        class="w-full py-5 bg-[var(--brand-primary)] text-white rounded-3xl text-[11px] font-black uppercase tracking-[0.4em] shadow-2xl shadow-[var(--brand-glow)] hover:bg-[var(--brand-dark)] transition-all flex items-center justify-center gap-4 group/btn disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            <!-- Sticky Bottom Info -->
            <div class="bg-[var(--brand-glow)]/10 px-10 py-6 border-t border-[var(--brand-glow)]/20 flex items-center justify-center gap-4">
                 <div class="flex items-center gap-2">
                     <i class="fas fa-shield-virus text-[var(--brand-primary)]/40 text-xs"></i>
                     <span class="text-[9px] font-black text-[var(--brand-primary)]/60 uppercase tracking-widest">Anti-Tab Switching Active</span>
                 </div>
                 <span class="w-1 h-1 bg-[var(--brand-primary)]/20 rounded-full"></span>
                 <div class="flex items-center gap-2">
                     <i class="fas fa-wifi text-[var(--brand-primary)]/40 text-xs"></i>
                     <span class="text-[9px] font-black text-[var(--brand-primary)]/60 uppercase tracking-widest">Auto-Save Enabled</span>
                 </div>
            </div>
        </div>
    </div>
...
<div id="loadingOverlay" class="fixed inset-0 bg-[var(--brand-dark)]/40 backdrop-blur-md z-[9999] hidden items-center justify-center">
    <div class="bg-white p-10 rounded-[3rem] shadow-2xl text-center space-y-6 max-w-xs w-full mx-4">
        <div class="w-20 h-20 bg-[var(--brand-glow)] rounded-full flex items-center justify-center mx-auto">
            <i class="fas fa-spinner fa-spin text-3xl text-[var(--brand-primary)]"></i>
        </div>
        <div class="space-y-1">
