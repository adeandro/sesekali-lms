...
@section('content')
    ...
    <script>
        ...
        function setupGatingSystem() {
            ...
            // Start continuous fullscreen monitoring
                    ...
                    if (promise) {
                        promise
                            .then(() => {
                                ...
                                console.log('✅ Fullscreen activated - exam started');
                            })
                            .catch((err) => {
        ...
        function autosaveAnswer(questionId) {
            ...
            fetch(`/student/exams/${attempt_id}/autosave`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
            ...
            .then(data => {
                ...
                if (data.success) {
                    // Silent save - no need for console.log
                }
            })
            .catch(error => {
