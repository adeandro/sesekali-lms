    ...
    <form action="{{ route('admin.exams.store') }}" method="POST" id="examForm" class="space-y-8">
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden group hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-500">
            ...
            <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <label class="group relative flex items-center p-6 bg-gray-50 rounded-[2rem] border-2 border-transparent hover:border-[var(--brand-primary)] hover:bg-white transition-all duration-200 cursor-pointer overflow-hidden shadow-sm hover:shadow-lg">
                    <input type="checkbox" name="randomize_questions" value="1" {{ old('randomize_questions') ? 'checked' : '' }} class="hidden peer">
                    <!-- Icon Box -->
                    <div class="w-12 h-12 rounded-2xl flex items-center justify-center mr-5 shadow-sm transition-colors duration-200 bg-gray-300 text-gray-500 peer-checked:bg-[var(--brand-primary)] peer-checked:text-white">
                ...
                <label class="group relative flex items-center p-6 bg-gray-50 rounded-[2rem] border-2 border-transparent hover:border-[var(--brand-primary)] hover:bg-white transition-all duration-200 cursor-pointer overflow-hidden shadow-sm hover:shadow-lg">
                    <input type="checkbox" name="token_required" value="1" x-model="tokenRequired" class="hidden peer">
                    <!-- Icon Box -->
                    <div class="w-12 h-12 rounded-2xl flex items-center justify-center mr-5 shadow-sm transition-colors duration-200 bg-gray-300 text-gray-500 peer-checked:bg-[var(--brand-primary)] peer-checked:text-white">
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden group hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-500"
             x-data="{ 
                examType: '{{ old('exam_type', 'harian') }}',
                tokenRequired: {{ old('token_required', true) ? 'true' : 'false' }},
                init() {
            ...
            <div class="p-8 space-y-8">
                    ...
                    <div class="relative">
                        <select id="exam_type" name="exam_type"
                            ...
                            @foreach(\App\Models\Exam::examTypes() as $value => $label)
                                <option value="{{ $value }}" {{ old('exam_type', 'harian') == $value ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                        <div class="absolute inset-y-0 right-0 pr-6 flex items-center pointer-events-none text-gray-400">
                            <i class="fas fa-chevron-down text-xs"></i>
                ...
                <div x-show="examType !== 'latihan'" x-cloak class="space-y-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <input type="text" id="academic_year_report" name="academic_year"
                                value="{{ old('academic_year', $configs['academic_year'] ?? '') }}"
                                :required="examType !== 'latihan'"
                    ...
                    <label class="group relative flex items-center p-6 bg-gray-50 rounded-[2rem] border-2 border-transparent hover:border-emerald-400 hover:bg-white transition-all duration-200 cursor-pointer overflow-hidden shadow-sm hover:shadow-lg">
                        <input type="checkbox" name="include_in_report" value="1" {{ old('include_in_report', true) ? 'checked' : '' }} class="hidden peer">
