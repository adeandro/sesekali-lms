...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="flex items-center gap-3">
        ...
        <h1 class="text-2xl font-bold" style="color: var(--brand-primary)">
            <i class="fas fa-folder-plus mr-2"></i>Buat Assignment Project
        </h1>
    </div>

    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8">
        <form method="POST" action="{{ route('admin.project-assignments.store') }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}"
                       placeholder="Contoh: Pembuatan Website Portofolio Siswa"
                ...
                <p class="text-xs text-gray-400 mt-1">Slug URL galeri publik akan dibuat otomatis dari judul ini.</p>
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          placeholder="Jelaskan instruksi tugas, kriteria penilaian, atau panduan pengerjaan..."
                          class="w-full border border-gray-200 rounded-2xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:border-transparent"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="max_slots" value="{{ old('max_slots', 1) }}"
                           min="1" max="10"
                           class="w-full border border-gray-200 rounded-2xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:border-transparent"
                           style="--tw-ring-color: var(--brand-primary)" required>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="datetime-local" name="starts_at" value="{{ old('starts_at') }}"
                           class="w-full border border-gray-200 rounded-2xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:border-transparent"
                           style="--tw-ring-color: var(--brand-primary)">
                    <p class="text-[11px] text-gray-400 mt-1">Kosongkan jika bisa langsung diupload</p>
